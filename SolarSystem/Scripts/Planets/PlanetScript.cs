...
public class PlanetScript: MonoBehaviour {
    ...
    private float escapeVelocity = 0f;
    ...
    private void Start() {
        ...
        // M = massa do planeta
        initVelocity = Mathf.Sqrt(2f * Constants.G * largePlanetMass / smallPlanet.position.magnitude);
        ...
        currentPosition = smallPlanet.position;
    }
